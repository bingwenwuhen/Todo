...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TodoForm = __webpack_require__(158);
	var TodoTable = __webpack_require__(159);
	    ...
	    render: function() {
	        return (
	            React.createElement("div", null, 
	                ...
	                React.createElement(TodoTable, {todos: this.state.todos, updateTodo: this.updateTodo, deleteTodo: this.deleteTodo})
	            )
	        )
	    }
	});
	...
	var TodoTable = React.createClass({displayName: "TodoTable",
	    render: function() {
	        var todos = this.props.todos.map(function(item) {
	            return React.createElement(TodoItem, {key: item.id, todo: item, updateTodo: this.props.updateTodo, deleteTodo: this.props.deleteTodo})
	        }.bind(this));
	        return (
	            React.createElement("div", null, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItem = React.createClass({displayName: "TodoItem",
	    ...
	    render: function() {
	        ...
	        if(t.status == 0){
	            updateBtn =  React.createElement("button", {onClick: this.handlerUpdate.bind(this, t.id, 1), className: "btn btn-primary"}, "Done")
	        }else{
	            updateBtn = React.createElement("button", {class: "btn-distance", onClick: this.handlerUpdate.bind(this, t.id, 0), className: "btn btn-primary"}, "Undone")
	        }
	        return (
	            React.createElement("tr", null, 
